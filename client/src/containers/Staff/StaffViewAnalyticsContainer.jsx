...
function StaffViewAnalyticsContainer() {
    ...
    return (
        <div className='flex-1 w-full grid grid-cols-2 gap-5 p-5'>
            <div className='border border-secondary min-h-[550px] bg-accent'>
                <div className='flex justify-center items-center bg-secondary h-12'>
                    <p>Submitted by You</p>
                </div>
                <div className='p-6'>
                    <div className='bg-base-100 flex flex-col gap-1 items-center px-10 py-4 border border-secondary rounded-lg'>
                        <img src={infoWarning} />
                        <p>You haven't submitted any data to analyse</p>
                    </div>
                </div>
            </div>
            <div className='border border-secondary min-h-[600px] bg-accent'>
                <div className='flex justify-center items-center bg-secondary h-12'>
